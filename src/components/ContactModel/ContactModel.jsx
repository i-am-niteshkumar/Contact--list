          ...
          <Row className='mb-3'>
            ...
            <Form.Group as={Col} md='6' controlId='validationCustom05'>
              ...
              >
                ...
                <option value='Executive Assistant'>Student</option>
                <option value='President'>Teacher</option>
                <option value='Vice President'>Engineer</option>
                <option value='Product Manager'>Profesor</option>
                <option value='Purchasing Manager'> Manager</option>
                <option value='Project Manager'>Project Manager</option>
                <option value='Finance Manager'>teacher assistent</option>
              </Form.Select>
              <Form.Control.Feedback type='invalid'>
